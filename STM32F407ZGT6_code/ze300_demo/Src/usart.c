...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, USART3_RS485TX_Pin|USART3_RS485RX_Pin);
...
void UART_EN_RS485_RX(UART_HandleTypeDef *huart)
{
    ...
    {
        HAL_GPIO_WritePin(USART3_RS485CE_GPIO_Port, USART3_RS485CE_Pin, GPIO_PIN_RESET);
    }
}
...
void UART_EN_RS485_TX(UART_HandleTypeDef *huart)
{
    if(huart->Instance == USART3)
    {
        HAL_GPIO_WritePin(USART3_RS485CE_GPIO_Port, USART3_RS485CE_Pin, GPIO_PIN_SET);
    }
}
...
bool UART_GET_EN_STATE(UART_HandleTypeDef *huart)
{
    ...
    if(huart->Instance == USART3)
    {
        bitstatus = HAL_GPIO_ReadPin(USART3_RS485CE_GPIO_Port, USART3_RS485CE_Pin);
    }
