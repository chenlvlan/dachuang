...
// !!!Notice!!!
// ①Enter "A+number" in the serial port to set the speed of the M0 motor. For example, if you enter "A10", the speed of the M0 motor will be set to 10rad/s. Enter "B+number" to set the speed of the M1 motor.
