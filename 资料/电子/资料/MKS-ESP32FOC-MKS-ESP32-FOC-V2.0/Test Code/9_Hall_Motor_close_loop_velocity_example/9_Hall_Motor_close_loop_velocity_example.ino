//MKS ESP32 FOC V2.0 | Hall Motor Close Loop Velocity Example | Library:SimpleFOC 2.2.1 | Hardware:MKS ESP32 FOC V2.0

// !!!Notice!!!
//①Enter T+speed in the serial port window to make the two motors rotate in a closed loop. For example, if you want both motors to rotate at a speed of 20 rad/s, enter T20.
